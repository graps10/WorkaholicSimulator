...
namespace Hypertonic.Modules.UltimateSockets.PlaceableItems
{
    public class PlaceableItem : MonoBehaviour
    {
        ...
        public void HandleEnteredPlaceableZone(Socket socket)
        {
            ...
            {
                var newDistance = Vector3.Distance(socket.transform.position, _rootTransform.position);
                var currentDistance = Vector3.Distance(_closestSocket.transform.position, _rootTransform.position);
