...
namespace Hypertonic.Modules.UltimateSockets.Highlighters
{
    public class SocketHighlighter : MonoBehaviour
    {
        ...
        private void HandleItemWithinHighlightArea(PlaceableItem placeableItem)
        {
            if (_isHighlighting)
            {
                SetHologramRotation(placeableItem);
                return;
            }
        ...
        public void SetHologramRotation(PlaceableItem placeableItem) 
        {
            ...
            {
                ((ISocketHighlighter)entry.HighlighterComponent).SetHologramRotation(placeableItem);
            }
        }
