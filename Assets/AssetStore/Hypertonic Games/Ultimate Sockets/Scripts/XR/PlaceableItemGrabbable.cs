...
namespace Hypertonic.Modules.UltimateSockets.XR
{
    ...
    public class PlaceableItemGrabbable : MonoBehaviour
    {
        ...
        {
            _grabbableItem.HandleExitedPlaceableZone(placeableItem.ClosestSocket, placeableItem);
        }

        private void HandleEnteredPlaceableZone(PlaceableItem placeableItem)
        {
            _grabbableItem.HandleEnteredPlaceableZone(placeableItem.ClosestSocket, placeableItem);
        }
