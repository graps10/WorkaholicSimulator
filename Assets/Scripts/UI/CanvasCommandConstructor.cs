...
namespace UI
{
    public class CanvasCommandConstructor : ObjectConstructor<CanvasCommand, string>
    {
        ...
        private readonly CanvasCommandData[] _commandsData = {
            ...
            new(typeof(MoneyCanvasCommand), MoneyCanvasCommand.Path, PlayerCanvasReceiver.Instance),
            new(typeof(CrosshairCanvasCommand), CrosshairCanvasCommand.Path, PlayerCanvasReceiver.Instance)
        };
